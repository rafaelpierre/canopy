// Directories never returned by readDirRecursive. Venv directories are
// intentionally NOT here — they show in the file tree (dimmed via gitignore
// rules) so users can see freshly-created envs and browse if needed.
