...
[![version](https://forthebadge.com/api/badges/generate?panels=2&primaryLabel=version&secondaryLabel=0.2.0&primaryBGColor=%231A56DB&primaryTextColor=%23FFFFFF&secondaryBGColor=%231040A8&secondaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Roboto&primaryTextTransform=uppercase&secondaryFontSize=12&secondaryFontWeight=900&secondaryLetterSpacing=2&secondaryFontFamily=Montserrat&secondaryTextTransform=uppercase)](package.json)
[![electron](https://forthebadge.com/api/badges/generate?panels=2&primaryLabel=built+with&secondaryLabel=electron+41&primaryBGColor=%2347848F&primaryTextColor=%23FFFFFF&secondaryBGColor=%23316070&secondaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Roboto&primaryTextTransform=uppercase&secondaryFontSize=12&secondaryFontWeight=900&secondaryLetterSpacing=2&secondaryFontFamily=Montserrat&secondaryTextTransform=uppercase)](https://www.electronjs.org/)
[![svelte](https://forthebadge.com/api/badges/generate?panels=2&primaryLabel=powered+by&secondaryLabel=svelte+5&primaryBGColor=%23FF3E00&primaryTextColor=%23FFFFFF&secondaryBGColor=%23C43000&secondaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Roboto&primaryTextTransform=uppercase&secondaryFontSize=12&secondaryFontWeight=900&secondaryLetterSpacing=2&secondaryFontFamily=Montserrat&secondaryTextTransform=uppercase)](https://svelte.dev/)
[![python](https://forthebadge.com/api/badges/generate?panels=1&primaryLabel=python+first&primaryBGColor=%233776AB&primaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Montserrat&primaryTextTransform=uppercase)](https://python.org)
[![telemetry](https://forthebadge.com/api/badges/generate?panels=1&primaryLabel=zero+telemetry&primaryBGColor=%23111111&primaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Montserrat&primaryTextTransform=uppercase)](https://github.com/rafaelpierre/canopy)
[![uv](https://forthebadge.com/api/badges/generate?panels=1&primaryLabel=native+uv&primaryBGColor=%23B040CC&primaryTextColor=%23FFFFFF&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Montserrat&primaryTextTransform=uppercase)](https://github.com/astral-sh/uv)
[![ty](https://forthebadge.com/api/badges/generate?panels=1&primaryLabel=ty+type+checking&primaryBGColor=%23F7C948&primaryTextColor=%23111111&primaryFontSize=12&primaryFontWeight=600&primaryLetterSpacing=2&primaryFontFamily=Montserrat&primaryTextTransform=uppercase)](https://github.com/astral-sh/ty)
